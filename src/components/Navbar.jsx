  ...
  return (
    ...
    >
      ...
      >
        ...
        <a
          href="#hero"
          className="relative z-50 font-display text-xl font-semibold text-primary-900
        ...
        <button
          ...
          className="relative z-50 md:hidden p-2 text-primary-900
                     hover:text-accent-600 transition-colors duration-200"
        ...
        <div
          id="mobile-menu"
          className={`
            fixed inset-0 bg-neutral-50 z-40
